...
echo "  $OUTPUT"
echo ""
echo "Runtime config defaults to:"
echo "  \${XDG_CONFIG_HOME:-~/.config}/iyagi-terminal/.env"
echo "Data defaults to:"
...
echo "IYAGI_HOST/IYAGI_USER are optional defaults only."
echo ""
