...
if not defined BRIDGE_DEBUG set "BRIDGE_DEBUG=0"
if not defined BRIDGE_DEBUG_RENDER_SERVER set "BRIDGE_DEBUG_RENDER_SERVER=0"
if not defined BRIDGE_SSH_ANNOUNCE_IYAGI set "BRIDGE_SSH_ANNOUNCE_IYAGI=1"
if /I "%IYAGI_BRIDGE_DEBUG_OVERRIDE%"=="1" set "BRIDGE_DEBUG=1"
